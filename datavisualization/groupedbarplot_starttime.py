...
averagecmd='cat '+processdir+'/outputfile.txt | grep \'STARTED Application started\' | awk \'{print $1","$5}\' > '+processdir+'/average.txt'
...
plt.title('Startup time per JVM 8u202')
plt.tight_layout()
